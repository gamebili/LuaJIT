...
static int absindex_zero_index(lua_State *L)
{
  (void)lua_absindex(L, 0);
  return 0;
}

static int absindex_too_negative(lua_State *L)
{
...
static int capi_tostring_none_meta(lua_State *L)
{
  (void)L;
  return 0;
}

static int capi_tostring_nil_meta(lua_State *L)
{
  lua_pushnil(L);
  return 1;
}

static int capi_tostring_table_meta(lua_State *L)
{
  lua_newtable(L);
  lua_pushliteral(L, "table meta result");
  lua_setfield(L, -2, "marker");
  return 1;
}

static int capi_tostring_function_meta(lua_State *L)
{
  lua_pushcfunction(L, capi_tostring_meta);
  return 1;
}

static char capi_tostring_lightuserdata_sentinel;

static int capi_tostring_lightuserdata_meta(lua_State *L)
{
  lua_pushlightuserdata(L, &capi_tostring_lightuserdata_sentinel);
  return 1;
}
...
static int capi_tostring_userdata_meta(lua_State *L)
{
  int *ud = (int *)lua_newuserdatauv(L, sizeof(int), 0);
  *ud = 0x54;
  return 1;
...
static int laux_tolstring_nil_meta_arg(lua_State *L)
{
  lua_newtable(L);
  lua_newtable(L);
  lua_pushcfunction(L, capi_tostring_nil_meta);
  lua_setfield(L, -2, "__tostring");
  lua_setmetatable(L, -2);
  luaL_tolstring(L, -1, NULL);
  return 1;
...
static int laux_tolstring_table_meta_arg(lua_State *L)
{
  lua_newtable(L);
  lua_newtable(L);
  lua_pushcfunction(L, capi_tostring_table_meta);
  lua_setfield(L, -2, "__tostring");
  lua_setmetatable(L, -2);
  luaL_tolstring(L, -1, NULL);
  return 1;
...
static int laux_tolstring_function_meta_arg(lua_State *L)
{
  lua_newtable(L);
  lua_newtable(L);
  lua_pushcfunction(L, capi_tostring_function_meta);
  lua_setfield(L, -2, "__tostring");
  lua_setmetatable(L, -2);
  luaL_tolstring(L, -1, NULL);
  return 1;
...
static int laux_tolstring_lightuserdata_meta_arg(lua_State *L)
{
  lua_newtable(L);
  lua_newtable(L);
...
static int laux_tolstring_userdata_meta_arg(lua_State *L)
{
  lua_newtable(L);
  lua_newtable(L);
  lua_pushcfunction(L, capi_tostring_userdata_meta);
  lua_setfield(L, -2, "__tostring");
  lua_setmetatable(L, -2);
  luaL_tolstring(L, -1, NULL);
  return 1;
...
static void test_stack_and_number_api(lua_State *L)
{
  ...
  check_fresh_invalid_value(L, absindex_zero_index,
			    "lua_absindex rejects zero index",
			    "lua_absindex zero index error");
  check_fresh_invalid_value(L, absindex_too_negative,
...
static void test_lauxlib_api(lua_State *L)
{
  ...
  }
  {
    ...
    lua_setmetatable(L, -2);
    check(L, luaL_callmeta(L, -1, "__tostring") == 1,
	  "luaL_callmeta calls function-result metamethod");
    check(L, lua_gettop(L) == top + 2,
	  "luaL_callmeta keeps function result");
    check(L, lua_iscfunction(L, -1) &&
	  lua_tocfunction(L, -1) == capi_tostring_meta,
	  "luaL_callmeta function result");
    lua_pop(L, 2);
  }
  {
    int top = lua_gettop(L);
    ...
    lua_setmetatable(L, -2);
    check(L, luaL_callmeta(L, -1, "__tostring") == 1,
	  "luaL_callmeta calls lightuserdata-result metamethod");
    check(L, lua_gettop(L) == top + 2,
	  "luaL_callmeta keeps lightuserdata result");
    check(L, lua_islightuserdata(L, -1) &&
	  lua_touserdata(L, -1) == &capi_tostring_lightuserdata_sentinel,
	  "luaL_callmeta lightuserdata result");
    lua_pop(L, 2);
  }
  {
    int top = lua_gettop(L);
  ...
  }
  {
    ...
    lua_setmetatable(L, -2);
    check(L, luaL_callmeta(L, -1, "__tostring") == 1,
	  "luaL_callmeta calls userdata-result metamethod");
    check(L, lua_gettop(L) == top + 2,
	  "luaL_callmeta keeps userdata result");
    ud = (int *)lua_touserdata(L, -1);
    check(L, lua_type(L, -1) == LUA_TUSERDATA && !lua_islightuserdata(L, -1) &&
	  ud != NULL && *ud == 0x54, "luaL_callmeta userdata result");
    lua_pop(L, 2);
  }
  {
    int top = lua_gettop(L);
  ...
  }
  {
    ...
    lua_setmetatable(L, -2);
    check(L, luaL_callmeta(L, -1, "__tostring") == 1,
	  "luaL_callmeta calls no-result metamethod");
    check(L, lua_gettop(L) == top + 2,
	  "luaL_callmeta pads no-result metamethod");
    check(L, lua_isnil(L, -1), "luaL_callmeta no-result value");
    lua_pop(L, 2);
  }
  {
    int top = lua_gettop(L);
    ...
    lua_setmetatable(L, -2);
    check(L, luaL_callmeta(L, -1, "__tostring") == 1,
	  "luaL_callmeta calls nil-result metamethod");
    check(L, lua_gettop(L) == top + 2,
	  "luaL_callmeta keeps explicit nil result");
    check(L, lua_isnil(L, -1), "luaL_callmeta nil-result value");
    lua_pop(L, 2);
  }
  {
    int top = lua_gettop(L);
    ...
    lua_setmetatable(L, -2);
    check(L, luaL_callmeta(L, -1, "__tostring") == 1,
	  "luaL_callmeta calls table-result metamethod");
    check(L, lua_gettop(L) == top + 2,
	  "luaL_callmeta keeps table result");
    lua_getfield(L, -1, "marker");
    check_string(L, -1, "table meta result", "luaL_callmeta table result");
    lua_pop(L, 3);
  }
  ...
  lua_pushcfunction(L, laux_tolstring_nil_meta_arg);
  status = lua_pcall(L, 0, 0, 0);
  check(L, status == LUA_ERRRUN, "luaL_tolstring nil __tostring status");
  check(L, strstr(lua_tostring(L, -1), "'__tostring' must return a string") != NULL,
	"luaL_tolstring nil __tostring error");
  lua_pop(L, 1);

  lua_pushcfunction(L, laux_tolstring_table_meta_arg);
  status = lua_pcall(L, 0, 0, 0);
  check(L, status == LUA_ERRRUN, "luaL_tolstring table __tostring status");
  check(L, strstr(lua_tostring(L, -1), "'__tostring' must return a string") != NULL,
	"luaL_tolstring table __tostring error");
  lua_pop(L, 1);

  lua_pushcfunction(L, laux_tolstring_function_meta_arg);
  status = lua_pcall(L, 0, 0, 0);
  check(L, status == LUA_ERRRUN, "luaL_tolstring function __tostring status");
  check(L, strstr(lua_tostring(L, -1), "'__tostring' must return a string") != NULL,
	"luaL_tolstring function __tostring error");
  lua_pop(L, 1);

  lua_pushcfunction(L, laux_tolstring_lightuserdata_meta_arg);
  status = lua_pcall(L, 0, 0, 0);
  check(L, status == LUA_ERRRUN,
  ...
  lua_pushcfunction(L, laux_tolstring_userdata_meta_arg);
  status = lua_pcall(L, 0, 0, 0);
  check(L, status == LUA_ERRRUN, "luaL_tolstring userdata __tostring status");
  check(L, strstr(lua_tostring(L, -1), "'__tostring' must return a string") != NULL,
	"luaL_tolstring userdata __tostring error");
  lua_pop(L, 1);
