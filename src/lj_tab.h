...
LJ_FUNC cTValue *lj_tab_getstr_node(GCtab *t, const GCstr *key);
LJ_FUNC cTValue *lj_tab_geti64(GCtab *t, int64_t key);
...
LJ_FUNC TValue *lj_tab_seti64(lua_State *L, GCtab *t, int64_t key);
