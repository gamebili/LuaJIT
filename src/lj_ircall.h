...
#define IRCALLDEF(_) \
  ...
  _(ANY,	lj_strscan_toi64ok54,	1,  FN, INT, 0) \
  _(ANY,	lj_strscan_toi6454,	1,  FN, I64, 0) \
  _(ANY,	lj_strscan_toint64ok54, 1, FN, INT, 0) \
  _(ANY,	lj_strscan_toint6454,	1,  FN, I64, 0) \
  ...
  _(ANY,	lj_strfmt_i64,		2,  FN, STR, XA_64|CCI_L|CCI_T) \
  ...
  _(ANY,	lj_tab_geti64,		2,   S, PGC, XA_64) \
  _(ANY,	lj_tab_seti64,		3,   S, PGC, XA_64|CCI_L|CCI_T) \
  ...
  _(ANY,	lj_gc_barrierback,	2,  FS, NIL, 0) \
  _(ANY,	lj_mem_newgco,		2,  FA, PGC, CCI_L|CCI_T) \
  _(ANY,	lj_obj_newint64,	2,   A, INT64, XA_64|CCI_L|CCI_T) \
  ...
  _(ANY,	lj_vm_lua54fmod,	2,   N, NUM, XA2_FP) \
